...
<html>
    <head>
        ...
        <link href="http://localhost/Final_Project/material-kit-master/assets/css/material-kit.css?v=3.0.0" rel="stylesheet">
            ...
            <div class="container py-4">
              <div class="row">
                <div class="col-lg-7 mx-auto d-flex justify-content-center flex-column">
                  ...
                  <form role="form" id="contact-form" method="post" autocomplete="off" action="http://localhost/Final_Project/Final_Website/includes/process_form.php">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-lg-7 mx-auto d-flex justify-content-center flex-column">
                  <h3 class="text-center">Visit Information</h3>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            ...
                            <label class="form-label">12:00 AM
                    ...
                    <br>
                    <div class="col-md-12">
                      <h5 id="areasofinterest">Areas of Interest (select up to 3)</h5>
                      <br>
                      ...
                      <button type="button" class="btn btn-primary" id="btnSubmit3">Save</button>
                      </div>
                    </div>
                  </form>
                </div>
